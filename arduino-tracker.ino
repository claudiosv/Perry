...
#define LED_PIN LED_BUILTIN // Pin connected to an LED that flashes the status of the project.
...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println(F("GPS Tracker Started"));
    ...
    fonaSS.println("AT+CMEE=2"); //Enable +CME ERROR: result code and use verbose values
